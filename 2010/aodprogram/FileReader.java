...
public class FileReader {
   ...
   */
  private ZHTreeMap<String, String> tree;
  /*
   * A String to hold the input file name
   */
  private String fileName;
  /*
   * Strings to hold the information in first two lines
   */
  ...
  /*
   * Will reutrn the name of the input file
  ...
  public String getTime(){
    ...
    dayN=java.lang.Integer.parseInt(temp.substring(4,7));
    int hour=java.lang.Integer.parseInt(temp.substring(7,9));
    int minute=java.lang.Integer.parseInt(temp.substring(9,11));
    int m = minute*100/60;
    h=hour+m/100.00; 
    time=year+", "+ dayN+ ", "+ h;
    return time; 
  ...
  /*
   * Will return first line of the data file
   * @return String first line of the data file
   */
  ...
  /*
   * Will return second line of the data file
   * @return String second line of the data file
   */
