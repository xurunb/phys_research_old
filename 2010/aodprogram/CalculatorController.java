...
public class CalculatorController{
  ...
  public CalculatorController(String betaFN, String am0FN, String inputF, double p, double start, double end){
    ...
    int dayN=java.lang.Integer.parseInt(temp.substring(5,8));
    ...
    */
    int hour=java.lang.Integer.parseInt(temp.substring(9,11));
    int minute=java.lang.Integer.parseInt(temp.substring(11,13));
    int m = minute*100/60;
    ...
    sc.close();
    outputF="C"+inputF.substring(0, 13)+"-"+start+"-"+end;
    try{
